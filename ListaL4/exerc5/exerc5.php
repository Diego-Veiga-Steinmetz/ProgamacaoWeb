...
//=====================script principal=======================================
//mandamos o PHP incluirm, nesta área, o arquivo externo (inclde) com a definição das funções
include "exercicio5.inc.php";

if(isset($_POST['enviar-dados']))
{
  //receber os dados do formulário - vamos chamar este bloco de comando de bloco de comando de script principal
  $nota1 = $_POST['nota1'];
  $nota2 = $_POST['nota2'];
