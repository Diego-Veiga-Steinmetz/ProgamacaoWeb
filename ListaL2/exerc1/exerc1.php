...
<body> 
 ...
 <?php
  ...
  //fazendo a soma dos notas por meio de um comando específico do PHP que trabalha com vetores numéricos
  $soma = array_sum($notas);
  $media = $soma / count($notas);
  $mediaFormatada = number_format($media,1, ",",".");
  echo "<p> Caro professor, de acordo com as notas fornecidas, a média calculada para os três alunos cadastrados é igual <span> $mediaFormatada </span> </p>";
   ?>  
</body> 
</html> 
