...
<body> 
 ...
 <?php
  ...
  //Item b> navegar pelo vetor com o laço special foreach e fazer o navegador mostrar os dados de cada aluno no vetor, em uma tabela na página web
  ...
  // agora que já conhecemos a maior nota, usamos o comando do PHP que localiza a maior nota no vetor e o retorna o índice da célula que contém a maior nota. No nosso caso, é o nome do aluno que tem a maior nota
  $alunoMaiorNota = array_search($maiorNota, $alunos);
  echo "<p> Resultados da pesquisa com a maior nota: <br> Aluno com a maior nota = <span>$alunoMaiorNota</span> <br> Maior nota entre alunos = <span> $maiorNota </span> </p>";
   ?>  
</body> 
</html> 
